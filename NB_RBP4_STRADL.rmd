...
```
### add labels to variables to make plots/tables easier to read:
...
kable(main_data %>%select(`RBP4 (ug/ml)`,Sex) %>% group_by(Sex) %>% summarise_all(.funs=stats),digits = 2) %>% kable_minimal(full_width = F, html_font = "Cambria")
