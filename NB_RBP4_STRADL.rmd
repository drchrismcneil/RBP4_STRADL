...
M <- corr1$r
#M
colnames(M) <- c("Left Hippo", "Right Hippo", "Age", "ST Memory", "LT Memory", "Digit Symbol", "Verbal Fluency", "Vocabulary", "Matrix Reasoning", "Total Hippo", "Hippo/Brain", "Hippo/Skull", "Log10[RBP4]", "BMI")
rownames(M) <-  c("Left Hippo", "Right Hippo", "Age", "ST Memory", "LT Memory", "Digit Symbol", "Verbal Fluency", "Vocabulary", "Matrix Reasoning", "Total Hippo", "Hippo/Brain", "Hippo/Skull", "Log10[RBP4]", "BMI")
p_mat <- corr1$P
